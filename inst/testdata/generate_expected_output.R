...
run_singscore(emat, tiesMethod="average", dorothea_genesets, .source="tf",
              .target="target", .target_profile="mor", minsize=0, perm=100,
              ncores=6, directed=TRUE, tidy=FALSE) %>%
  saveRDS("inst/testdata/outputs/singscore/output-singscore_dorothea_avg.rds")
...
run_singscore(emat, tiesMethod="average", regnetwork_genesets, .source="tf",
              .target="target", .target_profile=NULL, minsize=0, perm=100,
              ncores=6, directed=FALSE, tidy=FALSE) %>%
