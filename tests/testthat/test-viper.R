...
emat = readRDS(
  system.file("testdata", "input-expr_matrix.rds", package = "decoupleR"))
dorothea_genesets = readRDS(
  system.file("testdata","input-dorothea_genesets.rds", package = "decoupleR"))
progeny_genesets = readRDS(
  system.file("testdata","input-progeny_genesets.rds", package = "decoupleR"))


test_that("test run_viper with dorothea gene sets", {
  res1 = run_viper(emat, dorothea_genesets, gs_resource="dorothea", tidy=F)
  exp1 = readRDS(
    system.file("testdata", "output-viper_dorothea_default.rds",
                package = "decoupleR")
  )
  res2 = run_viper(emat, dorothea_genesets, gs_resource="dorothea", tidy=T)
  exp2 = readRDS(
    system.file("testdata", "output-viper_dorothea_default_tidy.rds",
                package = "decoupleR")
  )
  ...
  exp3 = readRDS(
    system.file("testdata", "output-viper_dorothea_minsize4.rds",
                package = "decoupleR")
  )
...
test_that("test run_viper with progeny gene sets", {
  ...
  exp1 = readRDS(
    system.file("testdata", "output-viper_progeny_default.rds",
                package = "decoupleR")
  )
  res2 = run_viper(emat, progeny_genesets, gs_resource="progeny", tidy=T)
  exp2 = readRDS(
    system.file("testdata", "output-viper_progeny_default_tidy.rds",
                package = "decoupleR")
  )
  ...
  exp3 = readRDS(
    system.file("testdata", "output-viper_progeny_minsize4.rds",
                package = "decoupleR")
  )
