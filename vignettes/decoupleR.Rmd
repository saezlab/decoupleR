...
make benchmarks with easy extension.
...
be useful for manipulating results, but is not necessary.
...
Ready, you have applied different statistics to the same data set, now you can
