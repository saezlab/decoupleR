...
# Change assay
DefaultAssay(object = pbmc3k) <- "tfs_wmean"

# Scale the data
pbmc3k <- ScaleData(pbmc3k)
pbmc3k@assays$tfs_wmean@data <- pbmc3k@assays$tfs_wmean@scale.data
```
...
p2 <- (FeaturePlot(pbmc3k, features = c("PAX5")) & 
  scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
  ggtitle('PAX5 activity')
DefaultAssay(object = pbmc3k) <- "RNA"
p3 <- FeaturePlot(pbmc3k, features = c("PAX5")) + ggtitle('PAX5 expression')
DefaultAssay(object = pbmc3k) <- "tfs_wmean"
p1 | p2 | p3
```
...
df <- t(as.matrix(pbmc3k@assays$tfs_wmean@data)) %>%
  as.data.frame() %>%
